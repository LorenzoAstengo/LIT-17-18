    ...
    public partial class Form1 : Form
    {
        ...
        private void RedrawForm()
        {
            ...
            if (currentLocation is IHidingPlace)
            {
                ...
                check.Text = "Check " + hidingPlace.NameOfTheHidingPlace;
                check.Visible = true;
            }
            else
                check.Visible = false;
            if (currentLocation is IHasExteriorDoors)
        ...
        {
            livingRoom = new Exercise10.RoomWithDoor("Living Room", "an antique carpet",
                "inside the closet", "an oak door with a brass handle");
            diningRoom = new RoomWithHidingPlace("Dining Room", "a crystal chandelier",
                "in the tall armoire");
            kitchen = new Exercise10.RoomWithDoor("Kitchen", "stainless steel appliances",
        ...
        private void ResetGame(bool displayMessage)
        {
            if (displayMessage)
            {
                ...
                + " moves! He was hiding " + foundLocation.NameOfTheHidingPlace + ".";
            }
            Moves = 0;
            hide.Visible = true;
        ...
        {
            IHasExteriorDoors hasDoor = currentLocation as IHasExteriorDoors;
